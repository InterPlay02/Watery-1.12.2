...
public class MachineCrusher extends BlockBase implements ITileEntityProvider
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool CRUSHING = PropertyBool.create("crushing");
	
	public MachineCrusher(String name) {
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
	{
		...
		if(active) worldIn.setBlockState(pos, ModBlocks.CRUSHER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(CRUSHING, true), 3);
		else worldIn.setBlockState(pos, ModBlocks.CRUSHER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(CRUSHING, false), 3);
	...
	{
		TileEntityMachineCrusher tileentity = (TileEntityMachineCrusher)worldIn.getTileEntity(pos);
